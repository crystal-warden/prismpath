...
def _scripted(script):
    ...
    def agent(node, _instruction, _state):
        ...
        outcome = seq[min(visit_count, len(seq) - 1)]
...
def main() -> int:
    ...
    doc = {
        ...
        "canonical": [{"obj": canonical_obj,
                       "compact": json.dumps(canonical_obj, sort_keys=True, separators=(",", ":")),
                       "spaced": json.dumps(canonical_obj, sort_keys=True)} for canonical_obj in _CANONICAL_OBJS],
