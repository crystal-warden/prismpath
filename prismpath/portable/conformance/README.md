...
- **`capability.json`**: 6 cases pinning the **portability matrix** (`capabilityReport`): a flow →
...
([`prismpath-hw/`](https://github.com/crystal-warden/prism-path/blob/main/prismpath-hw/README.md)): the C target certifies 124/1,079 predicate + 6/27
